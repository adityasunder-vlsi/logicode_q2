...
My design uses more area than the reference, but achieves better performance.

My Design: 543.5 MHz, 1.840 ns

Reference: 520.8 MHz, 1.920 ns

Overall, I chose a simpler state-based approach using running, which was easier for me to understand while providing better timing performance.
